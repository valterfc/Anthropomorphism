% function Ti=fk(robot,q,notation)
% ----
% robot - robot object                                         
% q - joint coordinates vector (1xn vector)                
% Ti - struct of transformation matrices for all frames   
% ----
...
for i=1:n
DHMatrix(i,:)=[ q(i)+robot.links(i).theta robot.links(i).d robot.links(i).a  robot.links(i).alpha ];
end
