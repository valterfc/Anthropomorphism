% function a=getJointPositions(a,p,i,robot,q,frame,notation)
% ----
...
function [a,p]=getJointPositions(a,p,i,robot,q,frame,notation)
...
Tp = T{frame-1};
xyzp=transl(Tp)';
a.xyzsets(i).values=[a.xyzsets(i).values;xyza];
p.xyzsets(i).values=[p.xyzsets(i).values;xyzp];
